-- Communicate Spy v3  (compact + drag)
...
F.Position         = UDim2.new(0, 10, 0.5, -150)
...
local BtnCopy  = makeBtn("⎘ Copy",  60,  Color3.fromRGB(20, 35, 50),  Color3.fromRGB(100, 180, 255))
local BtnClear = makeBtn("✕ Clear", 116, Color3.fromRGB(30, 30, 45),  Color3.fromRGB(200, 200, 220))
local BtnClose = makeBtn("Close",   172, Color3.fromRGB(45, 20, 20),  Color3.fromRGB(220, 120, 120))

local StatusLbl = Instance.new("TextLabel")
StatusLbl.Size              = UDim2.new(0, 160, 1, 0)
StatusLbl.Position          = UDim2.new(1, -163, 0, 0)
...
local function setSelBarVisible(show)
    if show then
        F.Size       = UDim2.new(0, 460, 0, 316)
        Scroll.Size  = UDim2.new(1, 0, 1, -80)
        SelBar.Size  = UDim2.new(1, 0, 0, 16)
        SelBar.Position = UDim2.new(0, 0, 1, -16)
    else
        F.Size       = UDim2.new(0, 460, 0, 300)
        Scroll.Size  = UDim2.new(1, 0, 1, -64)
        SelBar.Size  = UDim2.new(1, 0, 0, 0)
...
BtnCopy.MouseButton1Click:Connect(function()
    if not selected or not logs[selected] then
        StatusLbl.Text       = "select row first"
